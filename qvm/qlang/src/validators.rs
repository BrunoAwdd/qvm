pub fn validate_gate_arity(name: &str, total_qubits: usize, args: &[&str]) -> Result<(), String> {
    match name {
        "hadamard" | "h" | "identity" | "id" | "paulix" | "x" | "pauliy" | "y" | "pauliz" | "z"
        | "s" | "s_dagger" | "sdagger" | "sdg" | "t" | "t_dagger" | "tdagger" | "tdg" => {
            validate_1q_gate(name, total_qubits, args)
        }
        ...
        "cnot" | "cx" | "swap" | "cy" | "cz" | "iswap" => {
            validate_2q_gate(name, total_qubits, args)
        }
