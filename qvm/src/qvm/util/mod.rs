...
pub fn get_cuda_gate_kernel(gate_name: &str) -> Option<GateKernel> {
    match gate_name {
        ...
        "ISwap"    => Some(GateKernel { kernel_name: "iswap_kernel",    ptx_file: "iswap.ptx", use_theta: false }),
        ...
        "U1"       => Some(GateKernel { kernel_name: "u1_kernel",       ptx_file: "u1.ptx", use_theta: true  }),
